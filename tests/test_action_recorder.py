...
import json
import os
from src.auto_ui_test.action_recorder import UserActionRecorder
...
class TestUserActionRecorder(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.recorder.settings["idle_time_limit"], 10)  # Adjusted to match the actual value
        self.assertFalse(self.recorder.state["recording"])

    @patch('src.auto_ui_test.action_recorder.mouse.Listener')
    @patch('src.auto_ui_test.action_recorder.keyboard.Listener')
    ...
    @patch('src.auto_ui_test.action_recorder.pyautogui.position')
    @patch('src.auto_ui_test.action_recorder.pyautogui.screenshot')
    ...
    def test_save_to_json(self, mock_screenshot):
        ...
        with open(json_file, "r", encoding="utf-8") as file:
            ...
            self.assertEqual(data[0]["action"], "click")
